  ...
  data () {
    return {
      ...
      doing: [
        ...
        {
          id: '风带来故事的种子，时间使其发芽。',
          content: '风带来故事的种子，时间使其发芽。',
        },
        {
          id: '漩涡无法击碎的磐岩，也终究会在时光的冲刷下磨损。',
          content: '漩涡无法击碎的磐岩，也终究会在时光的冲刷下磨损。',
        },
      ],
    };
  },
